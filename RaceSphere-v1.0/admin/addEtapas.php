                ...
                <div class="form-holder">
                    <div class="form-content">
                        <div class="form-items">
                            ...
                            <form action="addEtapas.php?id=<?php echo $id_prova ?>" action="POST" class="requires-validation"
                                novalidate>
                                <div class="col-md-12">
                                    Dia Etapa:
                                    <input class="form-control" id="diaEtapa" type="date"
                                        name="dia">
                                </div>
                                ...
                                <div class="col-md-12">
                                    Fim Etapa:
                                    <input class="form-control" type="time" name="fim"
                                        id="horaFim">
                                </div>
