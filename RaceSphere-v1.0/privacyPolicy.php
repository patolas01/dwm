...
<body>
        ...
        <div class="mainWrapper privPolicy">
                ...
                <p><span>Apenas retemos as informações coletadas pelo tempo necessário para fornecer
                                o
                                ...
                                autorizados.</span></p>
                <p><span>Não compartilhamos informações de identificação pessoal publicamente ou
                                com
                                terceiros, exceto quando exigido por lei.</span></p>
                <p><span>O nosso site pode ter links para sites externos que não são operados
                                por
                                nós.
                                ...
                                privacidade</a>.</p>
                <p><span>o utilizador é livre para recusar a nossa solicitação de informações pessoais,
                                entendendo que talvez não possamos fornecer alguns dos serviços desejados.</span></p>
                <p><span>O uso continuado de nosso site será considerado como aceitação de
                                nossas
                                práticas em torno de privacidade e informações pessoais. Se o utilizador tiver alguma
                                dúvida sobre como
                                lidamos com
                ...
                <ul>
                        <p><span>O utilizador se compromete a fazer uso adequado dos conteúdos e da
                                        informação
                                        que
                                        o RaceSphere oferece no site e com caráter enunciativo, mas não
                                        limitativo:</span></p>
                        <li><span>Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem
                                        pública;</span></li>
                        <li><span>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, azar, qualquer
                                        tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
                                        humanos;</span></li>
                        <li><span>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do RaceSphere,
                ...
                <p><span>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que o
                                ...
                                ativados, caso interaja com um dos recursos que o utilizador usa em nosso site.</span>
                </p>
