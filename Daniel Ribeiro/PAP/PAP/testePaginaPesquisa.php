...
<html>
    ...
    <body>
        ...
        <div style="background-color:#1b1b1b; float: left; width:80% ">
            ...
            <br>
                <Fieldset>
                    <legend align="left"> <font face="arial" size="4" color="#ffc119">You searched for <?php echo $pesquisa ?></font>
                    </legend>
                    <?php
                ...
                $sql = "SELECT * FROM animes where nomeAnime LIKE '%$pesquisa%' ORDER BY nomeAnime";
