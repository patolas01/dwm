...
<html>
    ...
    <body>
        ...
        <div style="background-color:#1b1b1b; float: left; width:80% ">
            ...
            <br>
                <Fieldset>
                    <legend align="left"> <font face="arial" size="4" color="#ffc119">Your <?php echo $pesquisa ?> list</font>
                    </legend>
                    <?php
                ...
                $sql = "SELECT animes.idAnime, animes.nomeAnime, animes.keyvisual, status.idAnime, status.id, status.status FROM animes INNER JOIN status ON animes.idAnime=status.idAnime where id='$_SESSION[id]' AND status='$pesquisa' ORDER BY nomeAnime";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "You don't have any anime marked as $pesquisa";
                }
                $conn->close();
            ?>
            </fieldset>
