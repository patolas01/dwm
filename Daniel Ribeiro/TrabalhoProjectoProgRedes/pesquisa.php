<html>
    <head>
        <title>MangaEngrish Search by name</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="wrapper" style="background-color:#1b1b1b;">
            ...
            <form>
                <Fieldset>
                    <legend align="left"> <font face="arial" size="4" color="#d61212">You searched for <?php echo $genero ?></font>
                    </legend>
            <!-- Primeira fila -->
            ...
            <?php
                ...
                $sql = "SELECT artigos.codartigo, artigos.nomeartigo, volumes.img1, volumes.precovenda,volumes.numvolume, volumes.codvolume FROM artigos inner join volumes on artigos.codartigo=volumes.codartigo where nomeartigo LIKE '%$genero%' order by numvolume";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "Sorry we didn't find what you were searching for";
                }
                $conn->close();
            ?>
            </div>
