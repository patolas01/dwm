<html>
    ...
    <body>
        <div class="wrapper" style="background-color:#1b1b1b;">
            ...
            <form>
                <Fieldset>
                    <legend align="left"> <font face="arial" size="4" color="#d61212">Recommended Manga</font>
                    </legend>
            <!-- Primeira fila -->
            ...
            <?php
                ...
                $sql = "SELECT artigos.codartigo, artigos.nomeartigo, volumes.img1, volumes.precovenda,volumes.numvolume, volumes.codvolume FROM artigos inner join volumes on artigos.codartigo=volumes.codartigo where modelo='manga' and numvolume='1' limit 10";
